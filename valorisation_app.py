...
/* Fix texte invisible : le voile blanc semi-transparent précédent laissait
   apparaître le fond blanc par défaut des inputs Streamlit sous un texte
   quasi-blanc. Fond sombre OPAQUE forcé + ciblage direct par type HTML
   (plus robuste que data-testid, dont la structure DOM interne peut varier). */
