...
:root {
  ...
  --apple-ease-soft: cubic-bezier(0.25, 0.1, 0.25, 1);
  --savills-teal: #008493;
...
/* ── Entrée de page en fondu — un seul mouvement orchestré, pas d'effets épars ── */
.main .block-container {
  animation: pageIn 0.5s var(--apple-ease) both;
}
@keyframes pageIn {
...
[data-testid="stSidebar"] [data-baseweb="select"] > div {
  transition: box-shadow 0.25s var(--apple-ease), border-color 0.25s var(--apple-ease) !important;
}
[data-testid="stSidebar"] input:focus {
  box-shadow: 0 0 0 3px rgba(255, 223, 0, 0.25) !important;
}

/* ── Métriques : légère entrée en cascade + micro-élévation au survol ── */
[data-testid="stMetric"] {
  ...
  animation: metricIn 0.45s var(--apple-ease) both;
}
[data-testid="stMetric"]:hover {
  transform: translateY(-2px);
  box-shadow: 0 8px 20px -8px rgba(37, 39, 58, 0.18);
}
@keyframes metricIn {
...
/* ── Boutons : easing spring, léger relief au survol, tassement au clic ── */
.stButton > button {
  ...
  transition: transform 0.25s var(--apple-ease), box-shadow 0.25s var(--apple-ease),
              background-color 0.2s var(--apple-ease-soft) !important;
  box-shadow: 0 2px 8px -2px rgba(0, 132, 147, 0.35);
}
.stButton > button:hover {
  background-color:#006d7a !important;
  transform: translateY(-1px);
  box-shadow: 0 6px 16px -4px rgba(0, 132, 147, 0.45);
}
.stButton > button:active {
  transform: translateY(0) scale(0.98);
  box-shadow: 0 2px 6px -2px rgba(0, 132, 147, 0.3);
}
.stDownloadButton > button {
  ...
  box-shadow: 0 2px 8px -2px rgba(255, 223, 0, 0.45);
}
.stDownloadButton > button:hover {
  transform: translateY(-1px);
  box-shadow: 0 6px 16px -4px rgba(255, 223, 0, 0.55);
}
.stDownloadButton > button:active {
  transform: translateY(0) scale(0.98);
}

/* ── Tabs : transition douce de couleur/soulignement, pas de saut brutal ── */
...
/* ── Expanders : ouverture douce ── */
[data-testid="stExpander"] {
  border-radius: 10px !important;
  transition: box-shadow 0.3s var(--apple-ease) !important;
}
[data-testid="stExpander"] summary {
  transition: color 0.2s var(--apple-ease-soft) !important;
}
...
[data-testid="stProgress"] > div {
  ...
  transition: width 0.4s var(--apple-ease-soft) !important;
}
[data-testid="stCheckbox"] { transition: opacity 0.2s var(--apple-ease-soft); }

/* ── Toasts / alerts : légère entrée ── */
[data-testid="stNotification"], .stAlert {
  animation: alertIn 0.35s var(--apple-ease) both;
}
@keyframes alertIn {
