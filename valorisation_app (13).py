...
with _hcol1:
    st.markdown(
        ...
        "Bureaux · Locaux d'activités · Commerce — Nantes Métropole</p>"
        "</div>",
...
with _bcol1:
    st.markdown(
        f"<div style='background:var(--surface-alt,#FAFBFC);border:1px solid #E6E8EC;"
        f"border-left:3px solid #008493;"
        f"padding:10px 16px;border-radius:10px;font-size:13px;color:#25273A'>"
        f"<span style='color:#8A93A3;font-weight:600;text-transform:uppercase;font-size:10.5px;"
        f"letter-spacing:0.04em'>Dossier actif</span><br>"
        f"<b>{_meta.get('nom_client','Sans nom')}</b> — "
